...
// -- START -- TEMPLATE HTML
	...
	foreach ( $ads as $key => $ad ) {
		...
		echo '<div class="a24pProItemInner__img" style="background-color: '.a24p_space($sid, 'ad_extra_color_1').'">'; // -- START -- ITEM IMG

			echo '<div class="a24pProItemInner__imgSymbol" style="color: '.a24p_space($sid, 'ad_extra_color_2').'">';

				echo '<div class="a24pProItemInner__imgSymbolBox"><i class="mdi-hardware-keyboard-arrow-right" style="border-color: '.a24p_space($sid, 'ad_extra_color_2').'"></i></div>';
