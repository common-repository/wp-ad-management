		...
		if ( $ad['url'] != '' ) {
			...
			echo '<div class="a24pProItemInner" style="background-color:'.a24p_space($sid, 'ad_bg').'">'; // -- START -- ITEM INNER
				...
				echo '<div class="a24pProItemInner__thumb">'; // -- START -- ITEM THUMB
					...
					echo '<div class="a24pProAnimateThumb animated">';

						echo '<div class="a24pProItemInner__img" style="background-image: url(&#39;'.a24p_crop_tool($crop, ((!isset($sid) && !isset($_POST['a24p_ad_id']) || isset($example)) ? $ad['img'] : a24p_upload_url(null, $ad['img'])), 400, 300).'&#39;)"></div>'; // -- ITEM -- IMG
