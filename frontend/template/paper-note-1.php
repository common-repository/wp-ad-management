...
// -- START -- TEMPLATE HTML
	...
	foreach ( $ads as $key => $ad ) {
		...
		echo '<div class="a24pProItemInner a24pNote a24pRounded" style="background-color:'.a24p_space($sid, 'ad_bg').'">'; // -- START -- ITEM INNER
		...
		if ( $ad['url'] != '' && $ad['url'] != '#' ) {
			echo '<span class="a24pProItemInner__url" style="color:'.a24p_space($sid, 'ad_url_color').'">http://'.$url['host'].'</span>'; // -- ITEM -- URL
		}
...
// -- END -- TEMPLATE HTML
	...
	$bgNote = (a24p_space($sid, "ad_extra_color_1") != '') ? a24p_space($sid, "ad_extra_color_1") : NULL;
	$borderNote = (a24p_space($sid, "ad_extra_color_2") != '') ? a24p_space($sid, "ad_extra_color_2").' '.a24p_space($sid, "ad_extra_color_2").' transparent transparent' : NULL;

	echo '
<style>
#a24p-paper-note-1 .a24pProItemInner.a24pNote:before {
	background: '.$bgNote.';
}
#a24p-paper-note-1 .a24pProItemInner.a24pNote.a24pRounded:before {
