...
// -- START -- TEMPLATE HTML
	...
	foreach ( $ads as $key => $ad ) {
		...
		echo '<div class="a24pProItemInner__img" style="background-image: url(&#39;'.( (!isset($sid) && !isset($_POST['a24p_ad_id']) || isset($example)) ? $ad['img'] : a24p_upload_url(null, $ad['img']) ).'&#39;)"></div>'; // -- ITEM -- IMG
